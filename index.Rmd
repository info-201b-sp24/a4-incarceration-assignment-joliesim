...
- IDEA: population of different racial groups in prison over Time
  - will have to group by year, and then add up the totals in all the counties.
  - then make new column?? (there wouldn't be the same as the amount of rows??) - maybe make new dataset?
